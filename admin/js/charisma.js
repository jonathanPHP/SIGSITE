...
function docReady(){
	...
	$('ul.gallery li').hover(function(){
		...
		$(this).append('<div class="well gallery-controls">'+
							'<p><a href="#" class="gallery-edit btn" title="Deletar imagem"><i class="icon-trash"></i></a> <a href="#" class="gallery-delete btn" title="Fechar visualização"><i class="icon-remove"></i></a></p>'+
						'</div>');
...
String.prototype.right = function()
{
	...
	$('.thumbnails').on('click','.gallery-edit',function(e){
		e.preventDefault();
		//get image id
		var imagem = $(this).parents('.thumbnail').attr('id');
		//alert($(this).parents('.thumbnail').attr('id'));
		if (confirm('Desejar realmente apagar a imagem '+imagem+" ?")) { 
		alert("A imagem será apagada.");
			window.location = '?deletar='+imagem;
		}
		else{
		alert("A imagem não será apagada.");
		}
	});
