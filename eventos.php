...
?>
		<div id="conteudo">
			...
			<div class="resumo-novidades">
					<a href="prosempre.php"><div class="novi-fotos"><img src="imagens/prosempre-thumb.png"></div></a>
					<div class="post-resumo-novidades">
						<a href="prosempre">
						<h3>ProSEmpre 2013.2</h3>
						Saiba mais sobre o processo seletivo da EJECT nesse semestre!
						</a>
					</div>
				</div>
			<!--div class="port">
